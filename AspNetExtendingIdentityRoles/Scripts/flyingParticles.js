...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleArray = [];
		this.lights = [{ellipseWidth:550, ellipseHeight:100, alpha:0.6, offsetX:0, offsetY:0, color:"#6ac6e8"}, 
						{ellipseWidth:1350, ellipseHeight:1250, alpha:0.3, offsetX:-50, offsetY:0, color:"#54d5e8"}, 
						{ellipseWidth:1000, ellipseHeight:800, alpha:0.2, offsetX:80, offsetY:-50, color:"#2ae8d8"}];
